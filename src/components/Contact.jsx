...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // e.g., sending the data to a server or an email service
...
<div className="container mx-auto px-5 py-24">
  ...
  <div className="mb-12 flex w-full flex-col text-center">
    ...
    <p className="mx-auto text-base leading-relaxed lg:w-2/3 text-white">Feel free to reach out to us! Whether you have a question,
