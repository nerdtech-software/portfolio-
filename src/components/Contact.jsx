      ...
      <section className="body-font relative bg-gray-900 text-gray-400">
        <div className="container mx-auto px-5 py-24">
          ...
          <div className="mx-auto md:w-2/3 lg:w-1/2">
            <form action="https://fabform.io/f/{form-id}" method="post" className="-m-2 flex flex-wrap">
            ...
            <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
              ...
              <span className="inline-flex">
                ...
                <a href="/" aria-label="Twitter" className="ml-4 text-gray-500">
                  <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="h-5 w-5" viewBox="0 0 24 24">
                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                  </svg>
                </a>
                <a href="/" aria-label="Instagram" className="ml-4 text-gray-500">
                ...
                <a href="/" aria-label="LinkedIn" className="ml-4 text-gray-500">
                  <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="h-5 w-5" viewBox="0 0 24 24">
